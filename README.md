...
`sn_api_compatibility()` reports a projectless connection as
incompatible and instructs you to reconnect with a canonical Project
UUID. This does not change projectless access to compatible
public/direct DB endpoints that omit the capability or advertise it as
false.
